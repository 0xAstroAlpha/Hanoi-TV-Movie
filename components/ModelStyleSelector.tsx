    ...
    return (
        <div className="flex flex-col h-full">
            ...
            <div className="flex-1 relative min-h-0">
                ...
                >
                    {/* Grid: 5 cols mobile, 4 cols tablet+, smaller gaps */}
                    <div className="grid grid-cols-5 sm:grid-cols-4 gap-1 sm:gap-1.5">
                        {currentModels.map((model) => (
                            ...
                            >
                                ...
                                {/* Selected Indicator */}
                                {selectedId === model.id && (
                                    <div className="absolute top-0.5 right-0.5 w-3 h-3 sm:w-4 sm:h-4 bg-feudal-gold rounded-full flex items-center justify-center shadow-lg">
                                        <span className="text-black text-[6px] sm:text-[8px] font-bold">✓</span>
                                    </div>
                                )}
